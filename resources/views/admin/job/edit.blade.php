        ...
        <div class="col-sm">
            ...
            <form class="mt-4" method="POST" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{ old('title') ?? $job->title }}" class="form-control" placeholder="Enter Job Title" required>
                </div>

                <div class="form-group">
                    <textarea type="text" name="desc" rows="7" cols="100" class="form-control mb-2" placeholder="Job description">{{ old('desc') ?? $job->desc }}</textarea>
                </div>

                <div class="form-group">
                    <label>Contacts Info :</label>
                    <input type="text" name="contact" value="{{ old('contact') ?? $job->contact }}" class="form-control" placeholder="Enter Contacts Info" required>
                </div>
